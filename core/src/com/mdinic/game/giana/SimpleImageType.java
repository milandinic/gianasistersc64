...
public enum SimpleImageType {
    ...
    BIG_CLOUD(3, 1, 0xfaffff), SMALL_CLOUD(2, 1, 0xfaf0ff), MUSHROOM(2, 2, 0xe56262), ROUND_BUSH(2, 2, 0x7be562), WIDE_BUSH(
            ...
            0xe562F2, true), STATIC_ALIEN(1, 2, 0xe5F262, true), SMALL_COLUMN(1, 1, 0xdFdc71, true), SPIRAL(1, 1,
            0xffc2c2), SPIRAL_WAGON(3f, 0.3f, 0x68b7b6), MAGICWATER(1, 0.1f, 0x3631a8), END_LEVEL_DOOR(2, 2, 0xff00ff);
